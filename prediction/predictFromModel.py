import pandas
from data_preprocessing import preprocessing, file_methods
...
class Prediction:
    ...
    def predictionFromModel(self):
        ...
        try:
            self.pred_data_val.deletePredictionFile()  # deletes the existing prediction file from last run! some text

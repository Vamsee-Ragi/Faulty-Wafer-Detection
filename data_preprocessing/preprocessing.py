...
class Preprocessor:
    """
    Class to preprocess the input data so it can be fed to the models
    """
    ...
    def remove_columns(self, data, list_of_cols_to_be_removed):
        """
        ...
        try:
            input_df = data
            altered_df = input_df.drop(columns=list_of_cols_to_be_removed, axis=1)
    ...
    def separate_label_features(self, data, label_column):
        """
        ...
        try:
            ...
            self.logger.log(self.file_object, 'Label Separation Successful. Exited the separate_label_feature method '
                                              'of the Preprocessor class')
            return self.X, self.Y
        except Exception as e:
            self.logger.log(self.file_object,
                            'Exception occured in separate_label_feature method of the Preprocessor class. Exception '
                            'message:  ' + str(e))
            self.logger.log(self.file_object,
    ...
    def is_null_present(self, data):
        ...
        try:
            ...
            self.logger.log(self.file_object,
                            'Exception occured in is_null_present method of the Preprocessor class. Exception '
                            'message:  ' + str(e))
            self.logger.log(self.file_object,
    ...
    def impute_missing_values(self, data):
        ...
        try:
            ...
            self.logger.log(self.file_object,
                            'Exception occured in impute_missing_values method of the Preprocessor class. Exception '
                            'message:  ' + str(e))
            self.logger.log(self.file_object,
    ...
    def get_columns_with_zero_std_deviation(self, data):
        ...
        try:
            ...
            self.logger.log(self.file_object,
                            'Exception occured in get_columns_with_zero_std_deviation method of the '

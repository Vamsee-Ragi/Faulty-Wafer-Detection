...
from data_preprocessing import file_methods
...
class TrainModel:
    ...
    def training_model(self):
        ...
        try:
            ...
            data_getter = data_loader.DataLoader(self.file_object, self.log_writer)
            ...
            X, Y = preprocessor.separate_label_features(data, label_column='Output')
            ...
            kmeans = clustering.Clustering(self.file_object, self.log_writer)  # object initialization.
